...
RENAME TO companion_proactive_attention_v9;
...
CREATE TABLE companion_proactive_attention (
    ...
    kind TEXT NOT NULL CHECK (kind IN ('focus_finished', 'reunion')),
...
FROM companion_proactive_attention_v9;

DROP TABLE companion_proactive_attention_v9;
