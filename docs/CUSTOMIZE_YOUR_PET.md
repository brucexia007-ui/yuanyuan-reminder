...
需要从照片制作时，将[完整提示词](../AI_CUSTOMIZATION_PROMPT.md)和照片交给 Coding 工具，填写名称与性格；这就是普通用户需要完成的全部操作。工具负责从 https://github.com/brucexia007-ui/yuanyuan-reminder 核实来源并制作、验收宠物包。下方修改应用身份的步骤仅适用于明确要求独立程序的任务。
